    ...
    <div>
     ...
     <button id='google-sing-in-button' onClick={() => login()} className="gsi-material-button">
        ...
        <div className="gsi-material-button-content-wrapper">
          ...
          <span className="gsi-material-button-contents" id='sign-in-text'>Sign in with Google</span>
          <span style={{ display: 'none' }} id='other-sign-in-text'>Sign in with Google</span>
        </div>
      </button>
